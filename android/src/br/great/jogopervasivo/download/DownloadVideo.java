...
public class DownloadVideo extends AsyncTask<Void, Void, File> {
    ...
    public File downloadVideoSincrono() throws IOException {
        ...
        Log.i(Constantes.TAG,"Baixando video:" +arquivo+ " em "+ Constantes.SERVIDOR_DE_ARQUIVOS + "cvideos/" + arquivo);
        URL url = new URL(Constantes.SERVIDOR_DE_ARQUIVOS + "cvideos/" + arquivo);
        ...
        Log.i("Debug", "Video baixado: " + arquivo);
        return video;
    }
